...
export function ContainerBigDuplo(props: ContainerBigProps) {
    ...
    return (
        <div className="flex  justify-between mx-40 mb-2.5 gap-6 h-1/4 h-100 py-[25px]" >
            <div className="flex flex-col items-start gap-6 w-1/2  rounded-xl py-[20px] min-h-full py-[20px] px-[40px]" style={themeStyles[valueTheme]}>
                <h2 className="text-4xl">{Title}</h2>
                <p className="text-base text-left leading-normal">{Description}</p>
            </div>
            <div className="flex flex-col items-center gap-6 w-1/2  rounded-xl py-[20px] min-h-full py-[20px] px-[40px]" style={themeStyles[valueTheme]}>
