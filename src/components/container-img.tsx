...
export function ContainerImg(props: ContainerImgProps) {
    ...
    return (
        <div className="grid grid-cols-2 grid-rows-1  mx-40 mb-2.5 gap-6 py-[25px]">
            <div className="flex flex-col items-start justify-center gap-6  h-full rounded-xl " >
                <h2 className="text-4xl ">{Title}</h2>
                <button className="py-2 px-4 bg-purple-500 rounded-xl w-1/2 text-white" >{TextButton}</button>
            </div>
            <div className="flex items-end justify-end  h-full rounded-xl" >
                <img src={imgCaminho} alt="img" className="w-full rounded-xl" />
            </div>
            <div className="col-span-2  text-center rounded-xl grid-cols-2" > 
